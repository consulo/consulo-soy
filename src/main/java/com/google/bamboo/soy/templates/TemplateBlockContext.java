...
@ExtensionImpl
public class TemplateBlockContext extends BaseTemplateContextType {
  @Inject
  protected TemplateBlockContext() {
    super("CLOSURE_TEMPLATE_TEMPLATE_BLOCK", LocalizeValue.localizeTODO("Closure template: template block"));
  }
